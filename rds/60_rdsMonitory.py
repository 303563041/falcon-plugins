...
class Resource():
    ...
    def __init__(self):
        ...
        self.monitor_keys = [
            ('cCom_select','COUNTER'),
            ('qQcache_hits','COUNTER'),
            ('cCom_insert','COUNTER'),
            ('cCom_update','COUNTER'),
            ('cCom_delete','COUNTER'),
            ('cCom_replace','COUNTER'),
            ('mMySQL_QPS','COUNTER'),
            ('mMySQL_TPS','COUNTER'),
            ('rReadWrite_ratio','GAUGE'),
            ('iInnodb_buffer_pool_read_requests','COUNTER'),
            ('iInnodb_buffer_pool_reads','COUNTER'),
            ('iInnodb_buffer_read_hit_ratio','GAUGE'),
            ('iInnodb_buffer_pool_pages_flushed','COUNTER'),
            ('iInnodb_buffer_pool_pages_free','GAUGE'),
            ('iInnodb_buffer_pool_pages_dirty','GAUGE'),
            ('iInnodb_buffer_pool_pages_data','GAUGE'),
            ('bBytes_received','COUNTER'),
            ('bBytes_sent','COUNTER'),
            ('iInnodb_rows_deleted','COUNTER'),
            ('iInnodb_rows_inserted','COUNTER'),
            ('iInnodb_rows_read','COUNTER'),
            ('iInnodb_rows_updated','COUNTER'),
            ('iInnodb_os_log_fsyncs','COUNTER'),
            ('iInnodb_os_log_written','COUNTER'),
            ('cCreated_tmp_disk_tables','COUNTER'),
            ('cCreated_tmp_tables','COUNTER'),
            ('cConnections','COUNTER'),
            ('iInnodb_log_waits','COUNTER'),
            ('sSlow_queries','COUNTER'),
            ('bBinlog_cache_disk_use','COUNTER'),
            ('sStatus', 'GAUGE')
        ]
        self.p = []
